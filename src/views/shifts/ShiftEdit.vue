  ...
  try {
    ...
    if (res && res.success && res.data) {
      ...
      form.value = {
        ...
        grace_period_minutes: sf.grace_period_minutes
      }
    }
  } catch (err) {
    alert('Gagal memuat data shift: ' + err.message)
  }
})
    ...
    <div class="mb-8 flex items-center gap-4">
      ...
      <div>
        ...
        <p class="text-xs text-slate-500">
          Ubah nama, kode, rentang waktu masuk/pulang, dan batas toleransi terlambat roster shift.
        </p>
      </div>
    </div>
