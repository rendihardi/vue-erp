...
onMounted(async () => {
  try {
    const res = await employeeStore.fetchDepartment(departmentId.value)
    ...
    alert('Gagal memuat data departemen: ' + err.message)
  }
})
    ...
    <div class="mb-8 flex items-center gap-4">
      ...
      <div>
        ...
        <p class="text-xs text-slate-500">
          Ubah nama dan batasan geofencing untuk kantor cabang/departemen absensi.
        </p>
      </div>
    </div>
